...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.168.1.245"];
pub const RS_PUB_KEY: &str = "hAtkvs2Bov9akMCo0lmtDy0xwT3g4zDLYN85we6Ir4s=";
...
pub mod keys {
    ...
    pub const OPTION_API_SERVER: &str = "http://192.168.1.245:21114";
